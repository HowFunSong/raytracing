...
void cornell_box(){
    ...
    shared_ptr<material> earth_surface = make_shared<lambertian>(make_shared<image_texture>("./textures/earthmap.jpg"));

    world.add(make_shared<quad>(point3(555,0,0), vec3(0,555,0), vec3(0,0,555), green));
    world.add(make_shared<quad>(point3(0,0,0), vec3(0,555,0), vec3(0,0,555), red));
    world.add(make_shared<quad>(point3(343, 554, 332), vec3(-130,0,0), vec3(0,0,-105), light));
    world.add(make_shared<quad>(point3(0,0,0), vec3(555,0,0), vec3(0,0,555), white));//下
    world.add(make_shared<quad>(point3(555,555,555), vec3(-555,0,0), vec3(0,0,-555), white));//中
    world.add(make_shared<quad>(point3(0,0,555), vec3(555,0,0), vec3(0,555,0), white));//上
    ...
    shared_ptr<hittable> earth = make_shared<sphere>(point3(83, 165 + 50, 83), 50, earth_surface);
    earth = make_shared<translate>(earth, vec3(130, 0, 65));
    world.add(earth);
    ...
    if (thread_in_use){
        cam.render_multi_threads(world, lights);
    }else
...
//     world.add(make_shared<sphere>(point3(-2, 7, 0), 2, difflight));
...
//     cam.max_depth         = 50;
//     cam.background        = color(0,0,0);//background is black
...
//     hittable_list world;
//     shared_ptr checker = make_shared<checker_texture>(0.32, color(.2, .3, .1), color(.9, .9, .9));
...
//     world = hittable_list(make_shared<bvh_node>(world));// 裝飾器調整world中物件的結構
